...
sudo_users = {SUDO,1872001747,1848065074}   
...
if hash or SudoBot(msg) or DevDEVLW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevDEVLW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevDEVLW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevDEVLW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevDEVLW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1872001747) then  
var = true  
elseif tonumber(user_id) == tonumber(1848065074) then
var = true 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@Bomba_sors")  
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'☆:[تحديثات البوت](t.me/rema95ali94) \n☆:[قناه السورس](t.me/rema95ali94)')
end
...
send(msg.chat_id_,0,"☆:العضو : {["..data.first_name_.."](T.ME/rema95ali94)}\n☆:["..DEVL_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "☆:عذرا » {["..data.first_name_.."](T.ME/rema95ali94)}\n☆:عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
function Bomba_sors_name(t1,t2)
if t2.id_ then 
...
bnnaGet(msg.sender_user_id_, Bomba_sors_name)
end
...
☆:↬SoUrCe DeViL 
𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝐃𝐕•⊰ⵧⵧⵧⵧⵧⵧ𓍻
☆:↬[Channel DEVL](t.me/rema95ali94) 
𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝐃𝐕•⊰ⵧⵧⵧⵧⵧⵧ𓍻
☆:↬[Information](t.me/rema95ali94)
𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝐃𝐕•⊰ⵧⵧⵧⵧⵧⵧ𓍻
☆:↬[DEVELOPER](t.me/Bomba_sors)
𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝐃𝐕•⊰ⵧⵧⵧⵧⵧⵧ𓍻
☆:↬[To talk to us](t.me/Bomba_sors)
𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝐃𝐕•⊰ⵧⵧⵧⵧⵧⵧ𓍻
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'☆:بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'rema95ali94')..') \n☆:تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'☆:بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'rema95ali94')..') \n☆:تـم قفـل التاك بالكتم ')
end,nil)   
...
function(arg,data) 
usertext = '\n☆:العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'rema95ali94')..')'
...
usertext = '\n☆:العضو » ['..result.title_..'](t.me/'..(username or 'rema95ali94')..')'
status  = '\n☆:تم كتمه عام من الكروبات'
texts = usertext..status
...
if database:get(bot_id.."Bomba_sors:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'Bomba_sors:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."Bomba_sors:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'Bomba_sors:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
local UserName = (b.username_ or "rema95ali94")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n☆:لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'rema95ali94')..')'
status  = '\n☆:تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n☆:العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☆:العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'rema95ali94')..')'
...
usertext = '\n☆: المستخدم » ['..result.title_..'](t.me/'..(username or 'rema95ali94')..')'
status  = '\n☆:تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n☆:العضو » ['..result.title_..'](t.me/'..(text1[3] or 'rema95ali94')..')'..'\n☆:تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'Bomba_sors:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'Bomba_sors:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☆:العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVL')..') '
...
* ☆:م10 ⏎اوامر الاعضاء*
𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝐃𝐕•⊰ⵧⵧⵧⵧⵧⵧ𓍻
彡 .[SoUrCe DeViL ](t.me/rema95ali94)☆ 
]]
...
☆:الاشعارات
𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝐃𝐕•⊰ⵧⵧⵧⵧⵧⵧ𓍻
彡 .[S𝗢𝗨𝗥𝗖𝗘 D??𝗩𝗜?? ](t.me/rema95ali94)☆
]]
send(msg.chat_id_, msg.id_,(help_text or Text)) 
return false
end
...
zx = JSON.decode(zh)
t = "\n☆:قائمه الزخرفه \nٴ ☆:𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝐃𝐕•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ☆:○ٴ \n"
i = 0
for k,v in pairs(zx.ok) do
i = i + 1
t = t..i.."-  "..v.." \n"
end
send(msg.chat_id_, msg.id_, t..'ٴ ☆:𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝐃𝐕•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ☆:○ٴ\n☆:彡 .[SoUrCe DeViL](t.me/rema95ali94)☆ ')
end
