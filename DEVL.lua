...
sudo_users = {SUDO,1712951948,1377884661,1033028167}   
...
send(msg.chat_id_, msg.id_,'⌁︙اصدار سورس جيفاره\n⌁︙الاصدار »{ 1.5v}')
end
if text == 'قناه تحديثات البوت⌁︙' and DevDEVLW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'⌁︙[تحديثات البوت](t.me/DEVIL901) \n⌁︙[قناه السورس](t.me/DEVIL901)')
end
...
⌁︙↬S𝗢𝗨𝗥𝗖𝗘 D𝗘𝗩𝗜𝗟 
⍆══•═══Dv══•═══⍅
⌁︙↬[Channel DEVL](t.me/DEVIL901) 
⍆══•═══Dv══•═══⍅
⌁︙↬[Information](t.me/DEVIL901)
⍆══•═══Dv══•═══⍅
⌁︙↬[DEVELOPER](t.me/D9l9l)
⍆══•═══Dv══•═══⍅
⌁︙↬[To talk to us](t.me/D9l9l)
 ⍆══•═══Dv══•═══⍅
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
local UserName = (b.username_ or "DEVIL901")
...
send(msg.chat_id_, msg.id_, t..'ٴ ⌁︙⊱•═════Dv═════•⊰ ⌁︙○ٴ\n⌁︙彡 .[𝘽??𝘼??𝘿 𝙏𝙀𝘼𝙈](t.me/DEVIL901)➢ ')
end
...
m.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(DEVL)
if Json_Info.ok == true and #mem_id == i then
local Msgs = {}
Msgs[0] = msg.id_
