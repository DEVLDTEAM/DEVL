...
local hash = database:sismember(bot_id.."WwWwB:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevSoFi(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
var = true  
elseif database:sismember(bot_id..'WwWwB:MN:TF'..chat_id, user_id) then
var = true 
...
bnnaGet(msg.sender_user_id_, WwWwB_name)
end
...
✮  ⦑ SOURCE DEVL ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
✮ ︙ [Source Channel](t.me/tsss2018)
✮ ︙ [Source Update ](t.me/tsss2018)     
✮ ︙ [Source developer](t.me/WwWwB)     
✮ ︙ [DEVL programmer](t.me/WwWwB) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
]] 
send(msg.chat_id_, msg.id_,Text)
return false
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."WwWwB:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'WwWwB:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
database:del(bot_id..'WwWwB:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ✮ ︙ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'WwWwB:MN:TF'..msg.chat_id_)
t = "\n ✮ ︙ قائمة المنظفين \n≪━━━━━━𝐷𝐸𝑉𝐿━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'WwWwB:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✮ ︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'tsss2018')..')'
status  = '\n ✮ ︙ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'WwWwB:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ✮ ︙ العضو » ['..result.title_..'](t.me/'..(username or 'tsss2018')..')'
status  = '\n ✮ ︙ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'WwWwB:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✮ ︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'tsss2018')..')'
status  = '\n ✮ ︙ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'WwWwB:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✮ ︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'tsss2018')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'WwWwB:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ✮ ︙ العضو » ['..result.title_..'](t.me/'..(username or 'tsss2018')..')'
status  = '\n ✮ ︙ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'WwWwB:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✮ ︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'tsss2018')..')'
status  = '\n ✮ ︙ تم تنزيله من المنظفين'
...
if not database:get(bot_id..'WwWwB:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'WwWwB:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."WwWwB:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."WwWwB:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "✮ ︙ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."WwWwB:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."WwWwB:allM"..msg.chat_id_)
...
if database:sismember(bot_id..'WwWwB:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'WwWwB:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
database:set(bot_id.."tsss2018:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✮  تم تفعيل الانستا')
database:set(bot_id.."tsss2018:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."tsss2018:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."tsss2018:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✮ ︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."tsss2018:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."tsss2018:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"دنجب ☹️😂","عيب🥺😂","☹️😂ماما متقبل" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
